...
export const CASE_STUDIES: CaseCardData[] = [
  ...
  { bg: '/sbk-dubai-realestate.webp', homeBg: '/home-card-sbk.webp', cat: 'Real Estate', client: 'Batterjee Properties', title: 'Real Estate Developer', result: <>Targeted lead generation achieving <strong>high-quality pipeline</strong> in competitive UAE market.</>, href: '/case-studies/sbk-properties' },
];
