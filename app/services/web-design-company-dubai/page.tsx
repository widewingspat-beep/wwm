...
export async function generateMetadata(): Promise<Metadata> {
  return getPageMetadata('web-app-development');
}
  ...
  return (
    <div className="wad-page">
      ...
      <section className="cb-section wad-intro-section">
        ...
        <div className="container">
          ...
          <div className="wad-intro-header" data-reveal>
            <h2 className="wad-intro-center-title">Your Top Web Design<br /><span className="gradient-text">Company in Dubai</span></h2>
      ...
      <section className="cb-section cb-section-alt wad-expertise-section">
        ...
        <div className="container">
          <div className="wad-exp-editorial">
            {/* Left 30% — title + label */}
            <div className="wad-exp-editorial-left">
              <h2 data-reveal className="wad-exp-section-title">Web Design Company in Dubai:<br /><span className="gradient-text">For All Types of Industries.</span></h2>
              <p data-reveal className="wad-exp-sub-label">Expertise &amp; Insights</p>
            </div>
            {/* Right 70% — 2-col grid of cards */}
            <div className="wad-exp-editorial-right">
              {[
                ...
                <div key={i} data-reveal data-reveal-delay={`${i * 60}`} className="wad-exp-card">
